...
export function Intro() {
  // Show intro on every page reload (no session caching)
        ...
        >
          ...
          >
            ...
            >
              ...
              {/* Circular logo with padding so the logo image fits cleanly inside a perfect circle */}
              <div className="relative h-36 w-36 rounded-full overflow-hidden ring-4 ring-white/10 bg-white flex items-center justify-center p-5 shadow-2xl">
                <img
                  src={logoWhite}
                  alt="RDV logo"
